...
```
Project:      Emergency-CAD
Description:  CAD for EMS
Status:       planning
...
```
Language:     Detected: Kotlin/Android
...
---
*Auto-generated: 2026-07-22 | Extends: ShadowWalkerNC/.github/AGENTS.md | Repo: [Emergency-CAD](https://github.com/ShadowWalkerNC/Emergency-CAD)*
